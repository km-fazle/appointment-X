...
const RegisterForm =({user}: {user: User}) => {
  ...
  const form = useForm<z.infer<typeof PatientFormValidation>>({
    ...
    defaultValues: {
      ...
      email: user.email,
      phone: user.phone,
      gender: "male", // Fix the gender type to be "male" instead of "Male"
    },
  });
  ...
  return (
    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12 flex-1">
      ...
      <CustomFormField
        ...
        name = "email"
        label = "Email"
        placeholder = "gamingwithsangita@example.com"
      ...
      <CustomFormField
        ...
        name = "address"
        label = "Address"
        placeholder = "14th Street, New York 11223"
      ...
      <CustomFormField
        ...
        placeholder = "Peantus, Pollen, Shrimp etc."
      ...
      />
        ...
        placeholder = "Appendix, Tonsils, etc."
      /> 
      ...
      /> 
        ...
        label = "Scanned Copy of Identiication document"
        renderSkeleton = {(field) => (
          <FormControl>
